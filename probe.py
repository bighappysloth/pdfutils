...
parser.add_argument('-input','-i',type=pathlib.Path, required=True,help='File to Probe')
parser.add_argument('-pages','-p',type=int, nargs=2,required=True,help='page range to probe')
